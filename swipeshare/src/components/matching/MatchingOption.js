    ...
    <div className="matching-option">
      ...
      <div className="ai-matching-card">
        <div className="ai-matching-header">
          ...
          <div>
            <div className="ai-matching-title">Let AI match me</div>
            <div className="ai-matching-subtitle">with someone who needs this most</div>
          </div>
        </div>
        <button 
          onClick={onAIMatch}
          className="ai-matching-button"
        >
